...
(defmacro section (name &key
  ...
  `(if (project-p ,parent)
	 ...
	 (property! s :count-bars (or ,bars (bar-count tsig)))
	 (property! s :count-beats (or ,beats (beat-count tsig)))
	 (property! s :count-subbeats (or ,subbeats (subbeat-count tsig)))
	 (property! s :count-tsubbeats (or ,tsubbeats (tsubbeat-count tsig)))
